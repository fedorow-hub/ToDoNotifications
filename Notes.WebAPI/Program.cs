...
//добавляется провайдер для билдера
builder.Host.UseSerilog();

var configuration = builder.Configuration;

//конфигурируем AutoMapper здесь, а не в проекте Notes.Application, потому, что нам
//нужно получить информацию о текущей выполняющейся сборке
...
//для логирования:
//регистрируем сервис текущего пользователя для использования его через DI
builder.Services.AddSingleton<ICurrentUserService, CurrentUserService>();
//добавляем реализацию по умолчанию для HttpContextAccessor
